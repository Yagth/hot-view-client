      ...
      <div className="col-span-2  justify-center">
        <div className="flex flex-row items-center">
          <Avatar.Root className=" inline-flex items-center justify-center overflow-hidden w-10 h-10 rounded-full bg-black ">
            ...
            />
            <Avatar.Fallback
              className="w-full h-full flex items-center justify-center bg-white text-blue-black font-bold "
              delayMs={600}
            >
              {fallBackUName}
            </Avatar.Fallback>
          </Avatar.Root>
          <Label.Root className="pl-2 text-sm font-bold text-blue-black">
            {`${firstName} ${lastName}`}
          </Label.Root>
        </div>
